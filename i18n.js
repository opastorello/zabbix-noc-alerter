...
const I18N = {
  pt: {
    mon: 'Monitoramento', interval: 'Intervalo de checagem (seg)',
    ...
    ign_sup: 'Ignorar problemas suprimidos', ign_maint: 'Ignorar problemas em manutenção', tag_maint: 'Em manutenção', tag_new: 'NOVO', ign_ack: 'Ignorar problemas já reconhecidos (ack)',
    ...
    meet_suppress: 'Modo reunião (Google Meet)',
    meet_notif: 'Notificações', meet_sound: 'Sons',
    work_time: 'Alertar só no horário de trabalho',
    work_time_srv: 'Horário de trabalho do servidor: ',
    work_time_na: 'Não foi possível ler o horário de trabalho do servidor - opção indisponível.',
    ...
    test_btn: 'Testar', save: 'Salvar', reset: 'Restaurar padrões',
    ...
    cfg_url: 'Configure uma instância do Zabbix nas opções (engrenagem).',
    ...
    sort_by: 'Ordenar', sort_sev: 'Severidade', sort_age: 'Idade', sort_newest: 'Mais recente', sort_host: 'Host',
    grp_by: 'Agrupar', grp_none: 'Sem grupo', grp_host: 'Host', grp_inst: 'Instância', grp_toggle: 'Recolher/expandir grupo', no_host: '(sem host)',
    active: 'ativos', via_session: 'sessão', via_token: 'token', err: 'Erro', testing: 'Testando...', ago_now: 'agora', e_nocred: 'Sem credencial (sessão/token)', e_nourl: 'URL vazia',
    showing_of: 'Mostrando {n} de {total}', degraded_hosts: 'nomes de host indisponíveis', working_time_broken: 'horário de trabalho indisponível, alertando normalmente',
    t_mute: 'Mudo', t_check: 'Checar agora', t_settings: 'Configurações',
    n_resolved: 'Resolvido', n_recovered: 'problema recuperado', n_click: 'clique para abrir', and_more: 'e mais {n}',
  ...
  en: {
    mon: 'Monitoring', interval: 'Check interval (sec)',
    ...
    ign_sup: 'Ignore suppressed problems', ign_maint: 'Ignore problems in maintenance', tag_maint: 'In maintenance', tag_new: 'NEW', ign_ack: 'Ignore already acknowledged problems',
    ...
    meet_suppress: 'Meeting mode (Google Meet)',
    meet_notif: 'Notifications', meet_sound: 'Sounds',
    work_time: 'Alert only during working hours',
    work_time_srv: 'Server working hours: ',
    work_time_na: 'Could not read the server working hours - option unavailable.',
    ...
    test_btn: 'Test', save: 'Save', reset: 'Restore defaults',
    ...
    cfg_url: 'Add a Zabbix instance in options (gear).',
    ...
    sort_by: 'Sort', sort_sev: 'Severity', sort_age: 'Age', sort_newest: 'Newest', sort_host: 'Host',
    grp_by: 'Group', grp_none: 'No group', grp_host: 'Host', grp_inst: 'Instance', grp_toggle: 'Collapse/expand group', no_host: '(no host)',
    active: 'active', via_session: 'session', via_token: 'token', err: 'Error', testing: 'Testing...', ago_now: 'now', e_nocred: 'No credential (session/token)', e_nourl: 'Empty URL',
    showing_of: 'Showing {n} of {total}', degraded_hosts: 'host names unavailable', working_time_broken: 'working hours unavailable, alerting normally',
    t_mute: 'Mute', t_check: 'Check now', t_settings: 'Settings',
    n_resolved: 'Resolved', n_recovered: 'problem recovered', n_click: 'click to open', and_more: 'and {n} more',
  ...
  es: {
    mon: 'Monitoreo', interval: 'Intervalo de chequeo (seg)',
    ...
    ign_sup: 'Ignorar problemas suprimidos', ign_maint: 'Ignorar problemas en mantenimiento', tag_maint: 'En mantenimiento', tag_new: 'NUEVO', ign_ack: 'Ignorar problemas ya reconocidos (ack)',
    ...
    meet_suppress: 'Modo reunión (Google Meet)',
    meet_notif: 'Notificaciones', meet_sound: 'Sonidos',
    work_time: 'Alertar solo en horario laboral',
    work_time_srv: 'Horario laboral del servidor: ',
    work_time_na: 'No se pudo leer el horario laboral del servidor - opción no disponible.',
    ...
    test_btn: 'Probar', save: 'Guardar', reset: 'Restaurar valores',
    ...
    cfg_url: 'Configura una instancia de Zabbix en las opciones (engranaje).',
    ...
    sort_by: 'Ordenar', sort_sev: 'Severidad', sort_age: 'Edad', sort_newest: 'Más reciente', sort_host: 'Host',
    grp_by: 'Agrupar', grp_none: 'Sin grupo', grp_host: 'Host', grp_inst: 'Instancia', grp_toggle: 'Contraer/expandir grupo', no_host: '(sin host)',
    active: 'activos', via_session: 'sesión', via_token: 'token', err: 'Error', testing: 'Probando...', ago_now: 'ahora', e_nocred: 'Sin credencial (sesión/token)', e_nourl: 'URL vacía',
    showing_of: 'Mostrando {n} de {total}', degraded_hosts: 'nombres de host no disponibles', working_time_broken: 'horario laboral no disponible, alertando con normalidad',
    t_mute: 'Silencio', t_check: 'Comprobar ahora', t_settings: 'Configuración',
    n_resolved: 'Resuelto', n_recovered: 'problema recuperado', n_click: 'clic para abrir', and_more: 'y {n} más',
