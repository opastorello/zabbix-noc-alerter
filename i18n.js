...
const I18N = {
  pt: {
    ...
    filter_ph: 'Filtrar host ou problema', no_match: 'Nenhum resultado pro filtro.',
  ...
  en: {
    ...
    filter_ph: 'Filter host or problem', no_match: 'No matches for the filter.',
  ...
  es: {
    ...
    filter_ph: 'Filtrar host o problema', no_match: 'Sin resultados para el filtro.',
