...
const I18N = {
  pt: {
    ...
    showing_of: 'Mostrando {n} de {total}', degraded_hosts: 'nomes de host indisponíveis',
  ...
  en: {
    ...
    showing_of: 'Showing {n} of {total}', degraded_hosts: 'host names unavailable',
  ...
  es: {
    ...
    showing_of: 'Mostrando {n} de {total}', degraded_hosts: 'nombres de host no disponibles',
