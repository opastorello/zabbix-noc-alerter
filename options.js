...
const CHK = ['soundEnabled', 'notificationsEnabled', 'notifyResolved', 'badgeUnseen', 'repeatAlarm', 'ignoreAckd', 'ignoreSuppressed', 'ignoreMaintenance'];
...
function resetSettings() {
  ...
  const defaults = {
    ...
    ignoreAckd: false, ignoreSuppressed: true, ignoreMaintenance: true, badgeUnseen: false, muted: false, lang
  };
